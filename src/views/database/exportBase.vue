...
<div class='database-content'>
    ...
    <div class="export-box">
        ...
        <a-upload name="file" :multiple="false" :customRequest='customRequest' accept=".xlsx, .xls" :disabled='dataIsLoading'>
        ...
        <a-upload name="file" :multiple="true" :beforeUpload="beforeUploadphoto" :customRequest='customRequestphoto' accept="image/*" :disabled='photoIsLoading'>
        ...
        <a-modal v-model="modalVisible" title="" @ok="handleExportInfo" @cancel="handleCloseDelMulModatl" okText="是" cancelText="否" closable=false>
